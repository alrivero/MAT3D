...
var app = function() {
    ...
    self.lu_decomposition = function () {
        document.getElementById("no_table_parsertext").value = "ludec(";
    };
    ...
    self.cholesky_decomposition = function () {
        document.getElementById("no_table_parsertext").value = "chodec(";
    };
    ...
    self.cosecant = function () {
        document.getElementById("no_table_parsertext").value = "cosec(";
    };

    self.cotangent = function () {
        document.getElementById("no_table_parsertext").value = "cotan(";
    };
